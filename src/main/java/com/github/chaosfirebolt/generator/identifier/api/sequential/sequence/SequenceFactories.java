...
public class SequenceFactories {
  ...
  /**
   * Creates a sequence, whose result first is transformed by the mapper and then decorated with provided decorator.
   *
   * @param actualSequence the actual sequence generating elements
   * @param mapper         mapper to transform the element from the sequence
   * @param decoration     decorates the transformed element
   * @param <E>            type of the elements generated by the underlying sequence
   * @param <R>            type of the elements generated by the decorated sequence
   * @return new decorated sequence
   * @throws NullPointerException if any argument is null
   */
  public static <E, R> Sequence<R> decorated(Sequence<E> actualSequence, Function<E, R> mapper, SequenceDecoration<R> decoration) {
    Objects.requireNonNull(actualSequence, "Missing sequence");
    Objects.requireNonNull(mapper, "Missing mapper");
    Objects.requireNonNull(decoration, "Missing decoration");
    return new DecoratedSequence<>(actualSequence, mapper, decoration);
  }
}
