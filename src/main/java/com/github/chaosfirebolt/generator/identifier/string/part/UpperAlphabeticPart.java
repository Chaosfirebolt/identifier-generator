...
/**
 * identifier part for upper alphabetic characters.
 * <br>
...
public class UpperAlphabeticPart extends BasePart {
    ...
    /**
     * Constructor creating instance of identifier part for upper alphabetic chars, with desired length.
     * <br>
     * Minimum length is equal to the specified length.
     * @param length required length of the part
     * @throws IllegalArgumentException if length is less than 1
     */
    public UpperAlphabeticPart(int length) {
        this(length, length);
    }

    /**
     * Constructor creating instance of identifier part for upper alphabetic chars, with desired length and minimum length
     * @param length required length of the part
     ...
     */
    public UpperAlphabeticPart(int length, int minLength) {
